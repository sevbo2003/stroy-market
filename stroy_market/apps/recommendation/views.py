...
from apps.recommendation.models import Recommendation, RecommendationProduct
from apps.recommendation.serializers import RecommendationSerializer, RecommendationProductSerializer
